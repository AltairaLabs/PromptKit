...
All pack examples conform to the PromptPack Specification v1.7.0. See the [PromptPack Schema](../runtime/prompt/schema/promptpack.schema.json) for the complete specification.
