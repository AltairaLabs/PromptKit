      ...
      sidebar: [
        ...
        // array on a labeled group, not as a sibling of `label`/`collapsed`.
        {
          ...
          items: [
            ...
            // Curated examples only (the arena/examples directory also holds
            // empty auto-stubs, so it is not autogenerated here).
            { label: 'Examples', collapsed: true, items: [{ label: 'Voice Refund Demo', slug: 'arena/examples/voice-refund-demo' }] },
          ],
        },
        {
          label: 'SDK',
