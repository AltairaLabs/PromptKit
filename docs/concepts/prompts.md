...
- [Templates](templates.md) - Organizing prompts
- [Validation](validation.md) - Content safety
- [Runtime Templates](../runtime/how-to/use-templates.md) - Implementation
- [PackC](../packc/index.md) - Prompt packaging