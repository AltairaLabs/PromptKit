...
- [Integrate Tools](../runtime/how-to/integrate-tools.md) - Implementation guide
- [MCP Integration Tutorial](../runtime/tutorials/03-mcp-integration.md) - Step-by-step guide
- [Tools Reference](../runtime/reference/tools.md) - API documentation
- [MCP Architecture](../runtime/explanation/runtime-tools-mcp.md) - Technical details
