...
- **[ConversationManager](conversation-manager.md)** - Manage multi-turn conversations
- **[Conversation](conversation.md)** - Individual conversation instances
- **[PackManager](pack-manager.md)** - Load and manage PromptPacks

### Low-Level API

For advanced customization and control:

- **[PipelineBuilder](pipeline-builder.md)** - Build custom pipelines
- **[ToolRegistry](tool-registry.md)** - Register and manage tools
- **[Middleware](middleware.md)** - Custom middleware interfaces

### Core Types

Shared types and structures:

- **[Pack Format](pack-format.md)** - PromptPack JSON structure
...
- [ConversationManager](conversation-manager.md) - High-level conversation API
- [Conversation](conversation.md) - Conversation instance methods
...
- [PackManager](pack-manager.md) - Load and validate packs
- [Pack](pack-format.md) - Pack structure
- [Prompt](pack-format.md#prompt) - Prompt configuration
- [Tool](pack-format.md#tool) - Tool definition

**Pipeline Construction:**
- [PipelineBuilder](pipeline-builder.md) - Build pipelines
- [Middleware](middleware.md) - Custom middleware
- [ToolRegistry](tool-registry.md) - Tool registration
...
**Error Handling:**
- [Error Types](errors.md) - SDK error types
...
- **[ConversationManager Reference](conversation-manager.md)** - Start with high-level API
