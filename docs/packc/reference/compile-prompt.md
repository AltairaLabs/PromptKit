...
**Solution**: Check Go template syntax in user_template or system_prompt. Ensure `{{` and `}}` are balanced.
...
- [compile command](compile.md) - Compile all prompts from arena.yaml
- [validate command](validate.md) - Validate compiled packs
- [inspect command](inspect.md) - Inspect pack contents
- [Pack Format](../../sdk/explanation/promptpack-format.md) - Pack structure details
