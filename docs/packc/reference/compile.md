...
- [compile-prompt](compile-prompt.md) - Compile single prompt
- [validate](validate.md) - Validate pack file
- [inspect](inspect.md) - Inspect pack contents
- [How to Compile Packs](../how-to/compile-packs.md)
