...
- Completed [Tutorial 2: Multi-Prompt Packs](02-multi-prompt.md)
- Git installed
...
- **[Tutorial 4: Pack Management](04-pack-management.md)** - Organize and version packs
- **[How-To: Validate Packs](../how-to/validate-packs.md)** - More validation strategies
- **[How-To: CI/CD Integration](../how-to/ci-cd-integration.md)** - Automate in CI/CD
