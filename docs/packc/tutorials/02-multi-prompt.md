...
- Completed [Tutorial 1: Your First Pack](01-first-pack.md)
- packc installed
...
- **[Tutorial 3: Validation Workflows](03-validation-workflow.md)** - Ensure pack quality
- **[How-To: Organize Packs](../how-to/organize-packs.md)** - Structure your packs
- **[Reference: Pack Format](../explanation/pack-format.md)** - Understanding pack structure
