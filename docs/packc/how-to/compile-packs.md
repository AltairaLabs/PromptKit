...
- packc installed ([installation guide](install.md))
...
- [Validate Packs](validate-packs.md) - Ensure pack quality
- [Organize Pack Files](organize-packs.md) - Structure your packs
- [CI/CD Integration](ci-cd-integration.md) - Automate builds

## See Also

- [compile command reference](../reference/compile.md)
- [compile-prompt command reference](../reference/compile-prompt.md)
