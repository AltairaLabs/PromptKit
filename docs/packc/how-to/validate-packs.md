...
- [CI/CD Integration](ci-cd-integration.md) - Automate validation
- [Inspect Packs](../reference/inspect.md) - View pack details

## See Also

- [validate command reference](../reference/validate.md)
