...
Continue to [Tutorial 4: State Management](04-state-management) to learn how to persist conversations across sessions.

## Further Reading

- [How to Register Tools](../how-to/register-tools)
- [Tool Examples](../../../examples/tools/)
- [Tool Registry Reference](../reference/tool-registry)
