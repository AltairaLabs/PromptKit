...
Continue to [Tutorial 5: Custom Pipelines](05-custom-pipelines) to learn how to build custom processing pipelines.

## Further Reading

- [How to Manage State](../how-to/manage-state)
- [StateStore Reference](../reference/statestore)
- [Redis Store Configuration](../reference/redis-store)
