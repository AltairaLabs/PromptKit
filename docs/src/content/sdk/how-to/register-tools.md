...
- **[Handle Tool Calls](handle-tool-calls)** - Process tool requests
- **[Human-in-the-Loop](hitl-workflows)** - Approval workflows
- **[Tutorial: Tool Integration](../tutorials/03-tool-integration)** - Complete guide

## See Also

- [ToolRegistry Reference](../reference/tool-registry)
