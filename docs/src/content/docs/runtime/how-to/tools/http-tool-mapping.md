...
- [Register Tools](/runtime/how-to/tools/integrate-mcp/) - MCP tool integration
- [HTTP Tools SDK](/sdk/how-to/tools/http-tools/) - Programmatic HTTP tools with custom auth
