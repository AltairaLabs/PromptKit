...
- [Custom Hooks](/sdk/how-to/hooks/custom-hooks/) -- the same hook types implemented in Go
...
- [Use RuntimeConfig](/sdk/how-to/conversations/use-runtime-config/) -- configure the runtime via YAML
