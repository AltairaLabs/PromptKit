...
|-----------|-------------|-----------|
| **Pipeline** | Middleware-based execution engine | [pipeline.md](pipeline.md) |
| **Providers** | LLM provider implementations | [providers.md](providers.md) |
| **Tools** | Function calling and MCP integration | [tools.md](tools.md) |
| **MCP** | Model Context Protocol support | [mcp.md](mcp.md) |
| **State Store** | Conversation persistence | [statestore.md](statestore.md) |
| **Validators** | Content validation | [validators.md](validators.md) |
| **Types** | Core data structures | [types.md](types.md) |
...
- [Pipeline Reference](pipeline.md) - Detailed pipeline API
- [Provider Reference](providers.md) - Provider implementations
- [Tools Reference](tools.md) - Tool registry and execution
- [MCP Reference](mcp.md) - Model Context Protocol integration
- [Types Reference](types.md) - Core data structures
