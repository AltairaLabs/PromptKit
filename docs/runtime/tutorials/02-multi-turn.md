...
Continue to [Tutorial 3: MCP Integration](03-mcp-integration.md) to add external tools to your chatbot.

## See Also

- [Manage State](../how-to/manage-state.md) - Advanced state management
