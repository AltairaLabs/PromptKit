...
### Architecture
- [Pipeline Architecture](pipeline-architecture.md) - How the middleware-based pipeline works
- [Provider System](provider-system.md) - LLM provider abstraction and implementation

### Integration
- [Middleware Design](middleware-design.md) - Composable middleware patterns
- [State Management](state-management.md) - Conversation history and persistence
...
- Quickly complete a specific task → See [How-To Guides](../how-to/index.md)
- Learn Runtime from scratch → See [Tutorials](../tutorials/index.md)
- Look up API details → See [Reference](../reference/index.md)
...
- **[How-To Guides](../how-to/index.md)**: Task-focused guides
