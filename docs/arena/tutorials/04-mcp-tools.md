...
- Completed [Tutorial 1-3](01-first-test.md)
...
**Continue learning:**
- **[Tutorial 5: CI Integration](05-ci-integration.md)** - Automate tool testing in CI/CD
- **[How-To: MCP Tools](../how-to/use-mock-providers.md)** - Advanced tool configuration
- **[Runtime: Tools & MCP](../../runtime/reference/tools-mcp.md)** - Complete tool reference
