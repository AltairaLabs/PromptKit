...
- Completed [Tutorial 1](01-first-test.md) and [Tutorial 2](02-multi-provider.md)
...
**Continue learning:**
- **[Tutorial 4: MCP Tools](04-mcp-tools.md)** - Test tool/function calling in conversations
- **[Tutorial 5: CI Integration](05-ci-integration.md)** - Automate conversation testing
- **[How-To: Write Scenarios](../how-to/write-scenarios.md)** - Advanced patterns
