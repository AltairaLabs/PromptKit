// Package inspect provides the data types, collection logic, and text renderer
// for the PromptArena configuration inspector. It is shared between the
// cmd/promptarena CLI and the TUI hub pages.
package inspect
