...
require (
	github.com/AltairaLabs/PromptKit/pkg v1.5.2
	github.com/AltairaLabs/PromptKit/runtime v1.5.2
	github.com/AltairaLabs/PromptKit/tools/packc v1.5.2
...
require (
	...
	github.com/charmbracelet/x/exp/teatest v0.0.0-20260621010513-945fab64fd3e // indirect
