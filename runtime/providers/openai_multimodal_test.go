...
func TestOpenAIProvider_GetMultimodalCapabilities(t *testing.T) {
	provider := NewOpenAIProvider("test", "gpt-4o", "https://api.openai.com/v1", ProviderDefaults{}, false)
...
func TestOpenAIProvider_ValidateMultimodalMessage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := ValidateMultimodalMessage(provider, tt.message)
