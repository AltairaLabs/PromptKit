...
about: Suggest an idea for PromptKit
title: '[FEATURE] '
...
**Brief Description**
A clear and concise description of the feature you'd like to see added to PromptKit.
...
```go
// For SDK features, provide Go code examples
```

```yaml
# For Arena features, provide YAML configuration examples
```
...
**Who Benefits**
Describe who would benefit from this feature (e.g., Arena users testing with specific providers, SDK users building chatbots, etc.).
