...
//
// Pipecat WebSocket transport wire format.
// Source: https://github.com/pipecat-ai/pipecat/blob/main/src/pipecat/frames/frames.proto
...
const file_frames_proto_rawDesc = "" +
	...
	"\x04data\x18\x01 \x01(\tR\x04data\"\xe2\x01\n" +
	"\x05Frame\x12(\n" +
	...
	"\amessage\x18\x04 \x01(\v2\x15.pipecat.MessageFrameH\x00R\amessageB\a\n" +
	"\x05frameB?Z=github.com/AltairaLabs/PromptKit/benchmarks/harness/pipecatpbb\x06proto3"
...
func file_frames_proto_init() {
	...
	file_frames_proto_msgTypes[4].OneofWrappers = []any{
		(*Frame_Text)(nil),
		(*Frame_Audio)(nil),
