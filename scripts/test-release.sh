...
echo "================================================"
echo ""
echo "⚠️  Use '-test' suffix for test versions - they can be deleted within 5 min!"
echo ""
echo "1️⃣  Tag libraries with -test suffix:"
echo "    git tag runtime/v0.0.1-test"
echo "    git tag pkg/v0.0.1-test"
echo "    git tag sdk/v0.0.1-test"
echo "    git push origin runtime/v0.0.1-test pkg/v0.0.1-test sdk/v0.0.1-test"
echo ""
echo "2️⃣  Test SDK (wait 2-3 min, NOT 10!):"
echo "    mkdir -p /tmp/test-sdk && cd /tmp/test-sdk"
echo "    go mod init example.com/test"
echo "    go get github.com/AltairaLabs/PromptKit/sdk@v0.0.1-test"
echo "    cd - && rm -rf /tmp/test-sdk"
echo ""
echo "3️⃣  If successful, continue with tools (or DELETE within 5 min!)"
echo "    git push origin --delete runtime/v0.0.1-test pkg/v0.0.1-test sdk/v0.0.1-test"
echo ""
